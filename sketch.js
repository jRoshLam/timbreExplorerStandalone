...
function setup() {
	...
	// videoSlider = createSlider(0, 255, 127);
...
function windowResized() {
	...
	// videoSlider.position(0.05 * windowWidth, 0.85 * windowHeight);
	// videoSlider.size(0.65 * windowHeight, 0.1 * windowHeight);
}
